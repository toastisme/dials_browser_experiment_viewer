...
})({"1o5hJ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0478b9d6a77b6387";
"use strict";
...
},{}],"5JXrd":[function(require,module,exports) {
var _three = require("three");
var _orbitControlsJs = require("three/examples/jsm/controls/OrbitControls.js");
var _gsap = require("gsap");
var _threeMeshline = require("three.meshline");
var _exptParserJs = require("./ExptParser.js");
...
(function(global, factory) {
    ...
    class ExperimentViewer {
        ...
        static cameraPositions() {
            return {
                "default": new _three.Vector3(0, 0, -1000),
                "defaultWithExperiment": new _three.Vector3(-1000, 0, 0),
                "centre": new _three.Vector3(0, 0, 0)
            };
        }
        static text() {
            return {
        ...
        updateObservedIndexedReflections(val = null) {
            if (val !== null) this.observedIndexedReflsCheckbox.checked = val;
            ...
            for(var i = 0; i < this.bboxMeshesIndexed.length; i++)this.bboxMeshesIndexed[i].visible = showBbox;
            this.requestRender();
        }
        updateObservedUnindexedReflections(val = null) {
            if (val !== null) this.observedUnindexedReflsCheckbox.checked = val;
            ...
            for(var i = 0; i < this.bboxMeshesUnindexed.length; i++)this.bboxMeshesUnindexed[i].visible = showBbox;
            this.requestRender();
        }
        updateCalculatedReflections(val = null) {
            if (val !== null) this.calculatedReflsCheckbox.checked = val;
            for(var i = 0; i < this.reflPointsCal.length; i++)this.reflPointsCal[i].visible = this.calculatedReflsCheckbox.checked;
            this.requestRender();
        }
        updateBoundingBoxes(val = null) {
            if (val !== null) this.boundingBoxesCheckbox.checked = val;
            if (this.observedIndexedReflsCheckbox.checked && this.boundingBoxesCheckbox.checked) for(var i = 0; i < this.bboxMeshesIndexed.length; i++)this.bboxMeshesIndexed[i].visible = true;
            else for(var i = 0; i < this.bboxMeshesIndexed.length; i++)this.bboxMeshesIndexed[i].visible = false;
            if (this.observedUnindexedReflsCheckbox.checked && this.boundingBoxesCheckbox.checked) for(var i = 0; i < this.bboxMeshesUnindexed.length; i++)this.bboxMeshesUnindexed[i].visible = true;
            else for(var i = 0; i < this.bboxMeshesUnindexed.length; i++)this.bboxMeshesUnindexed[i].visible = false;
            this.requestRender();
        }
        updateAxes(val = null) {
            if (val !== null) this.axesCheckbox.checked = val;
            for(var i = 0; i < this.axesMeshes.length; i++)this.axesMeshes[i].visible = this.axesCheckbox.checked;
            this.requestRender();
        }
        updateReflectionSize() {
            if (!this.hasReflectionTable()) return;
            if (this.refl.containsXYZObs()) {
                if (this.reflPointsObsUnindexed) {
                    const reflGeometryObs = new _three.BufferGeometry();
                    reflGeometryObs.setAttribute("position", new _three.Float32BufferAttribute(this.reflPositionsUnindexed, 3));
                    const reflMaterialObs = new _three.PointsMaterial({
                        size: this.reflectionSize.value,
                        transparent: true,
                        color: ExperimentViewer.colors()["reflectionObsUnindexed"]
                    });
                    const pointsObs = new _three.Points(reflGeometryObs, reflMaterialObs);
                ...
                if (this.reflPointsObsIndexed) {
                    const reflGeometryObs = new _three.BufferGeometry();
                    reflGeometryObs.setAttribute("position", new _three.Float32BufferAttribute(this.reflPositionsIndexed, 3));
                    const reflMaterialObs = new _three.PointsMaterial({
                        size: this.reflectionSize.value,
                        transparent: true,
            ...
            if (this.refl.containsXYZCal() && this.reflPositionsCal) {
                const reflGeometryCal = new _three.BufferGeometry();
                reflGeometryCal.setAttribute("position", new _three.Float32BufferAttribute(this.reflPositionsCal, 3));
                const reflMaterialCal = new _three.PointsMaterial({
                    size: this.reflectionSize.value,
                    transparent: true,
                    color: ExperimentViewer.colors()["reflectionCal"]
                });
                const pointsCal = new _three.Points(reflGeometryCal, reflMaterialCal);
        ...
        addExperiment = async (file)=>{
            ...
            for(var i = 0; i < this.expt.getNumDetectorPanels(); i++)this.addDetectorPanelOutline(i);
            this.addBeam();
            this.addSample();
        ...
        addReflectionTable = async (file)=>{
            ...
            this.addReflections();
            if (this.hasReflectionTable()) this.showCloseReflButton();
            this.requestRender();
        };
        addReflections() {
            function getBboxMesh(bbox, bboxMaterial, viewer, pOrigin, fa, sa, pxSize) {
                const c1 = viewer.mapPointToGlobal([
                    bbox[0],
                    bbox[2]
                ], pOrigin, fa, sa, pxSize);
                const c2 = viewer.mapPointToGlobal([
                    bbox[1],
                    bbox[2]
                ], pOrigin, fa, sa, pxSize);
                const c3 = viewer.mapPointToGlobal([
                    bbox[1],
                    bbox[3]
                ], pOrigin, fa, sa, pxSize);
                const c4 = viewer.mapPointToGlobal([
                    bbox[0],
                    bbox[3]
                ], pOrigin, fa, sa, pxSize);
                const corners = [
                ...
                const bboxGeometry = new _three.BufferGeometry().setFromPoints(corners);
                const bboxLines = new _three.Line(bboxGeometry, bboxMaterial);
                return bboxLines;
            }
            ...
            const bboxMaterial = new _three.LineBasicMaterial({
            ...
            if (containsXYZObs) {
                if (containsMillerIndices) {
                    const reflGeometryObsIndexed = new _three.BufferGeometry();
                    reflGeometryObsIndexed.setAttribute("position", new _three.Float32BufferAttribute(positionsObsIndexed, 3));
                    const reflMaterialObsIndexed = new _three.PointsMaterial({
                        size: this.reflectionSize.value,
                        transparent: true,
                        color: ExperimentViewer.colors()["reflectionObsIndexed"]
                    });
                    const pointsObsIndexed = new _three.Points(reflGeometryObsIndexed, reflMaterialObsIndexed);
                ...
                const reflGeometryObsUnindexed = new _three.BufferGeometry();
                reflGeometryObsUnindexed.setAttribute("position", new _three.Float32BufferAttribute(positionsObsUnindexed, 3));
                const reflMaterialObsUnindexed = new _three.PointsMaterial({
                    size: this.reflectionSize.value,
                    transparent: true,
                    color: ExperimentViewer.colors()["reflectionObsUnindexed"]
                });
                const pointsObsUnindexed = new _three.Points(reflGeometryObsUnindexed, reflMaterialObsUnindexed);
            ...
            if (containsXYZCal) {
                const reflGeometryCal = new _three.BufferGeometry();
                reflGeometryCal.setAttribute("position", new _three.Float32BufferAttribute(positionsCal, 3));
                const reflMaterialCal = new _three.PointsMaterial({
                    size: this.reflectionSize.value,
                    transparent: true,
                    color: ExperimentViewer.colors()["reflectionCal"]
        ...
        mapPointToGlobal(point, pOrigin, fa, sa, scaleFactor = [
            1,
            1
        ]) {
        ...
        addDetectorPanelOutline(idx) {
            ...
            const planeGeometry = new _three.PlaneGeometry(192, 192);
            ...
            if (posVec.dot(normalVec) < 0) idxs = [
                0,
                3,
                1,
                2
            ...
            const line = new (0, _threeMeshline.MeshLine)();
            line.setPoints(corners);
            const material = new (0, _threeMeshline.MeshLineMaterial)({
                lineWidth: 7,
                color: ExperimentViewer.colors()["panel"],
                fog: true
            });
            const mesh = new _three.Mesh(line, material);
        ...
        addBeam() {
            ...
            incidentVertices.push(new _three.Vector3(bd.x * -beamLength, bd.y * -beamLength, bd.z * -beamLength));
            incidentVertices.push(new _three.Vector3(bd.x * -beamLength * .5, bd.y * -beamLength * .5, bd.z * -beamLength * .5));
            incidentVertices.push(new _three.Vector3(0, 0, 0));
            const incidentLine = new (0, _threeMeshline.MeshLine)();
            incidentLine.setPoints(incidentVertices);
            const incidentMaterial = new (0, _threeMeshline.MeshLineMaterial)({
                lineWidth: 5,
            ...
            const incidentMesh = new _three.Mesh(incidentLine, incidentMaterial);
            incidentMesh.raycast = (0, _threeMeshline.MeshLineRaycast);
            this.beamMeshes.push(incidentMesh);
            window.scene.add(incidentMesh);
            var outgoingVertices = [];
            outgoingVertices.push(new _three.Vector3(0, 0, 0));
            outgoingVertices.push(new _three.Vector3(bd.x * beamLength * .5, bd.y * beamLength * .5, bd.z * beamLength * .5));
            outgoingVertices.push(new _three.Vector3(bd.x * beamLength, bd.y * beamLength, bd.z * beamLength));
            const outgoingLine = new (0, _threeMeshline.MeshLine)();
            outgoingLine.setPoints(outgoingVertices);
            const outgoingMaterial = new (0, _threeMeshline.MeshLineMaterial)({
                lineWidth: 5,
                color: ExperimentViewer.colors()["beam"],
                transparent: true,
                opacity: .25,
            ...
            const outgoingMesh = new _three.Mesh(outgoingLine, outgoingMaterial);
            outgoingMesh.raycast = (0, _threeMeshline.MeshLineRaycast);
            this.beamMeshes.push(outgoingMesh);
            window.scene.add(outgoingMesh);
        }
        addSample() {
            const sphereGeometry = new _three.SphereGeometry(5);
        ...
        addAxes() {
            ...
            const xVertices = [
                ...
                new _three.Vector3(length, 0, 0)
            ];
            const yVertices = [
                new _three.Vector3(0, 0, 0),
                new _three.Vector3(0, length, 0)
            ];
            const zVertices = [
                new _three.Vector3(0, 0, 0),
                new _three.Vector3(0, 0, length)
            ];
        ...
        updateGUIInfo() {
            ...
            function updateReflectionInfo(viewer) {
                ...
                window.rayCaster.setFromCamera(window.mousePosition, window.camera);
                if (intersects.length > 0) for(var i = 0; i < intersects.length; i++){
        ...
        resetPanelColors() {
            for(var i in this.panelOutlineMeshes)this.panelOutlineMeshes[i].material.color = this.panelColor;
        }
        updateOriginObjectsOpacity() {
            ...
            for(var i = 0; i < this.axesMeshes.length; i++)this.axesMeshes[i].material.opacity = opacity * .5;
        }
        getClickedPanelPos() {
            window.rayCaster.setFromCamera(window.mousePosition, window.camera);
        ...
        zoomInOnPanel(panel, fitOffset = 1.1) {
            ...
            const direction = center.clone().normalize().multiplyScalar(distance);
	 ...
	 */ if (typeof window.viewer === "undefined") return;
        // Renderer
        window.renderer = new _three.WebGLRenderer();
        ...
        window.scene = new _three.Scene();
        window.scene.fog = new _three.Fog(ExperimentViewer.colors()["background"], 500, 3000);
        window.camera = new _three.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 100, 10000);
        window.renderer.render(window.scene, window.camera);
        window.rayCaster = new _three.Raycaster(); // used for all raycasting
        // Controls
        window.controls = new (0, _orbitControlsJs.OrbitControls)(window.camera, window.renderer.domElement);
        ...
        // Events
        window.mousePosition = new _three.Vector2();
        ...
        window.addEventListener("drop", function(event) {
            ...
            if (fileExt == "refl") window.viewer.addReflectionTable(file);
            else if (fileExt == "expt") window.viewer.addExperiment(file);
        });
        window.addEventListener("dblclick", function(event) {
            var panel = window.viewer.getClickedPanelMesh();
            if (panel) window.viewer.zoomInOnPanel(panel);
        });
        window.addEventListener("mousedown", function(event) {
            if (event.button == 2) window.viewer.rotateToPos(ExperimentViewer.cameraPositions()["defaultWithExperiment"]);
        });
        window.addEventListener("keydown", function(event) {
            if (event.key === "s") window.viewer.toggleSidebar();
        });
    ...
    window.viewer = new ExperimentViewer(new (0, _exptParserJs.ExptParser)(), new (0, _reflParserJs.ReflParser)());
    setupScene();
});

},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls.js":"7mqRv","gsap":"fPSuC","three.meshline":"4n0f9","./ExptParser.js":"dbzGd","./ReflParser.js":"g6Vmg","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"7mqRv":[function(require,module,exports) {
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"l02JQ":[function(require,module,exports) {
/*!
 * CSSPlugin 3.11.5
 * https://greensock.com
 *
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"4n0f9":[function(require,module,exports) {
(function() {
    "use strict";
    var root = this;
    var has_require = true;
    var THREE = root.THREE || has_require && require("33d929c578268330");
...
},{"33d929c578268330":"ktPTu"}]},["1o5hJ","5JXrd"], "5JXrd", "parcelRequire9102")

//# sourceMappingURL=ExperimentViewer.a77b6387.js.map
